...
\maketitle
\abstract{We introduce and test an approximate scheme for generating
mock catalogs for large-scale structure measurements in galaxy surveys,
specializing in this work to the Baryon Oscillation Spectroscopic
Survey. things to add later...A brief description of the approximation
scheme, tests and the accuracy we reach, and some comments about the
timings of the tests and the BOSS samples.}
...
\begin{figure}
\includegraphics[width=0.5\columnwidth]{\lyxdot \lyxdot /Plots/unmatchedHalo_frac_450_300_2_z0\lyxdot 15}
...
\begin{figure*}[p]
\includegraphics[width=0.5\columnwidth]{\lyxdot \lyxdot /Plots/crossMatter_m450_tweak_softMcut13\lyxdot 0_s0\lyxdot 5_z0\lyxdot 15}\includegraphics[width=0.5\columnwidth]{\lyxdot \lyxdot /Plots/crossMatter_tweak256_redshift_z0\lyxdot 15}
...
\begin{figure}
\includegraphics[width=0.5\columnwidth]{\lyxdot \lyxdot /Plots/hist_dist_z0\lyxdot 8to0\lyxdot 7}\includegraphics[width=0.5\columnwidth]{\lyxdot \lyxdot /Plots/hist_dist_z0\lyxdot 25to0\lyxdot 15}
...
\begin{figure}
\includegraphics[width=0.5\columnwidth]{\lyxdot \lyxdot /Plots/crossPower_shift_z0\lyxdot 8to0\lyxdot 7}\includegraphics[width=0.5\columnwidth]{\lyxdot \lyxdot /Plots/crossPower_shift_z0\lyxdot 15to0\lyxdot 25}
...
\begin{figure}
\includegraphics[width=0.5\columnwidth]{\lyxdot \lyxdot /Plots/crossPower_shift_ratio}
