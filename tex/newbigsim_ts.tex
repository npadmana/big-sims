...
In Section 4 and 5, we build a ight cone output and populate halos
in our samples with galaxies and compute correlation functions based
on BOSS Data Release \textcolor{red}{9/11(?) geometry}, and compare
it with the observed correlation function.
...
we used the formula presented in \cite{2011ApJ...740..102K}: 
\begin{equation}
...
the correlations function $\xi(s)$ with the one in \textcolor{black}{\cite{2013arXiv1303.4666A},
