...
\begin{figure}
\centering \includegraphics[width=0.5\columnwidth,bb = 0 0 200 100, draft, type=eps]{../Plots/zoom_in.eps}
...
%FIXME --- Make sure correctly set up
\begin{figure}
\includegraphics[width=0.5\columnwidth,bb = 0 0 200 100, draft, type=eps]{../Plots/overload.eps}
...
multiple halos correspond to one halo. }
\end{figure}
...
\begin{figure}
\includegraphics[width=0.45\columnwidth]{\lyxdot \lyxdot /Plots/shifting_r_z0\lyxdot 15}\includegraphics[width=0.45\columnwidth]{\lyxdot \lyxdot /Plots/shifting_s_z0\lyxdot 15}
...
\begin{figure}
\includegraphics[width=0.5\columnwidth]{\lyxdot \lyxdot /Plots/hist_velMag1}\includegraphics[width=0.5\columnwidth]{\lyxdot \lyxdot /Plots/hist_velMag1_expFac}

\caption{Histograms for velocities}
\end{figure}


\begin{figure}
\includegraphics[width=0.5\columnwidth]{\lyxdot \lyxdot /Plots/hist_velAngular}

\caption{Histograms for velocity angles}
...
\textcolor{red}{{*}Give actual numbers}
